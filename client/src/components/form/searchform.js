...
function SearchForm({ change }) {
  ...
  return (
    <Paper
      component="form"
      sx={{ p: '2px 4px', display: 'flex', alignItems: 'center', width: 300, border: 1, borderColor: '#011A3E' }}
    >
      <InputBase
      ...
      <IconButton type="button" sx={{ p: '10px', color: 'goldenrod' }} aria-label="search" onClick={handleSearch}>
        <SearchIcon />
      </IconButton>
